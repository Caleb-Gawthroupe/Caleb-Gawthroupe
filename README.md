...
* **TailorCV**: A full-stack application that leverages AI models (ChatGPT, Claude, Gemini) to automatically tailor LaTeX resumes based on specific job descriptions and target keywords. 
